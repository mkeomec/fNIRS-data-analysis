function [timevec, rhrf, rhrfStd] = testdeconv2016_05_17(optical,PVTtrigger,cogno,WP)
format long
...
settings.preRFseconds = 12;   % pre-stimulus-onset time (second)
settings.sucRFseconds = 12;  % suc-stimulus-onset time (second)
